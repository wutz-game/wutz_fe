...
for (const [cellId, color] of Object.entries(savedState)) {
  ...
  document.getElementById('resultsBtn').addEventListener('click', function() {
    ...
    const category_0 = document.getElementById('cat_0');
    const category_1 = document.getElementById('cat_1');
    const category_2 = document.getElementById('cat_2');

    gameCategories["cat_0"] = {
      name: category_0.getAttribute('data-cat-name'),
      emoji: category_0.getAttribute('data-cat-emoji')
    };

    gameCategories["cat_1"] = {
      name: category_1.getAttribute('data-cat-name'),
      emoji: category_1.getAttribute('data-cat-emoji')
    };

    gameCategories["cat_2"] = {
      name: category_2.getAttribute('data-cat-name'),
      emoji: category_2.getAttribute('data-cat-emoji')
    };

    document.cookie = `gameCategories=${JSON.stringify(gameCategories)}; path=/`;
  ...
  myForm.addEventListener('submit', function(e) {
    ...
    answeredQuestions[lastClickedCell.id] = {
      question_id: lastClickedCell.getAttribute('data-question-id'),
      userAnswer: input,
      correctAnswer: correct_answer,
      points: lastClickedCell.getAttribute('data-question-points'),
      override: false,
      skipped: false
        // Not skipped
    };
